...
V9 Cancellation Features
------------------------
- Track Order page includes customer cancellation request.
- Customer dashboard order history links to cancellation when eligible.
- Admin dashboard includes cancellation approval/rejection.
- Apps Script creates Cancellations sheet and refund tracking for paid cancelled orders.
- WhatsApp notification links are generated for cancellation request, approval and rejection.


V11 SET YOUR LOCATION
---------------------
This package includes a Freshly-style Set Your Location feature. Customers can open Set Location from the header, use current location, enter pincode, select area/Freshly Mart Hub, preview delivery slots and save the location. The saved location auto-fills checkout and is saved with the order as a Google Maps link when available. See SET_LOCATION_SETUP.txt.
