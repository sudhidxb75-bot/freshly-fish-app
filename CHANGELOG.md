...
## Freshly V3.7.6 - Working Base Revisions
- Used uploaded working V3.7.2 package as base.
- Fixed mobile menu category clicks to close menu before opening Shop.
- Fixed banner carousel to normalize banner rows and rotate all valid slides.
- Removed later experimental v3.7.3/v3.7.4 scripts from HTML loading.
- Apps Script functional update not required.
...
- Removed blank top gap above mobile banner.
- Added MobileTopShift backend option and setMobileBannerFullTop utility.
