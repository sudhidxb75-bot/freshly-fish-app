...
function openCategory(category){
  ...
  document.querySelectorAll('.menu,.nav .menu').forEach(menu=>menu.classList.remove('open','show','active','freshly-mobile-menu-open'));
  ...
  setTimeout(()=>{
    ...
    localStorage.setItem('freshlySelectedCategory', term);
