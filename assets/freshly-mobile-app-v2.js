...
function buildBottom(){
  ...
  n.innerHTML='<a class="active" href="index.html#home"><span class="nav-icon">🏠</span><span>Home</span></a><a href="index.html#shop"><span class="nav-icon">🧺</span><span>Shop</span></a><button type="button" data-open-cart data-nav-key="cart" aria-label="Open cart"><span class="cart-count-badge" data-cart-count>0</span><span class="nav-icon">🛒</span><span>Cart</span></button><a href="track-order.html"><span class="nav-icon">📦</span><span>Orders</span></a><button type="button" data-open-more data-nav-key="menu" aria-label="Open menu"><span class="nav-icon">☰</span><span>Menu</span></button>';
