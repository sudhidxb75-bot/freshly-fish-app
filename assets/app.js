(function(){
  // Freshly V3.8.11: backend-controlled banners + clean category/subcategory display.
  ...
  const state = {
    products: [], categories: [], subcategories: [], districts: [], hubs: [], areas: [], slots: [], districtPricing: [], banners: [], countries: [], settings: {},
