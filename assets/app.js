...
function updateTopLocationText(){
  ...
  if(typeof selectedArea !== 'undefined' && selectedArea){
    ...
    topLocationText.textContent = 'Kozhikode';
  }
}
...
function renderLocationSelector(){
  ...
  // v34 dropdown may not have locationButton. It only has topLocationText.
  // So do not stop rendering just because locationButton is missing.
  if(!list) return;
  ...
  if(topLocationText){
    topLocationText.textContent = selectedArea ? (selectedArea.area||selectedArea.city||selectedArea.pincode||'Kozhikode') : 'Kozhikode';
  }
...
// v34 helper: close location dropdown when user clicks outside
