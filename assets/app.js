...
const WHATSAPP_NUMBERS = ["919207850175"];
  ...
  box.innerHTML = `
    <div class="details-card">
      ...
      <div class="details-content">
        ...
        <div class="details-price">₹${fish.price}/Kg</div>
    ...
    fishData.forEach((fish,i)=>{
      ...
      <div class="card">
        ...
        <div class="content">
          ...
          <p class="stock" style="color:${fish.stock ? 'green':'red'}">${fish.stock ? 'In Stock':'Out of Stock'}</p>
          <button class="add" onclick="openFishDetails(${i})" ${fish.stock ? '' : 'disabled'}>${ml ? 'തിരഞ്ഞെടുക്കുക':'Select'}</button>
        </div>
      </div>`;
    });
  }catch(e){
