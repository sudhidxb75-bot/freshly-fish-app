    ...
    const show = n => {
      ...
      slides.forEach((slide, idx) => {
        ...
        slide.querySelectorAll('img').forEach(img => {
          ...
          img.style.objectFit = mobile ? 'cover' : (css.getPropertyValue('--banner-object-fit').trim() || 'cover');
          img.style.objectPosition = mobile ? 'center top' : (css.getPropertyValue('--banner-object-position').trim() || 'center center');
        });
      });
