...
const BACKEND_URL = "https://script.google.com/macros/s/AKfycbydKueiQNDTQG-hZHFcWiQIHKooIJpuz2aNWGD5SqjPimZh_xgpLwQlrag5zOf19gPspw/exec";
const WHATSAPP_NUMBER = "918921696649";

let fishData = [];
let deliveryAreas = [];
let cart = [];
let ml = false;8921696649
