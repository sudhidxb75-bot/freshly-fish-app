(function(){
  ...
  const demo = {
    ...
    districts:[{CountryCode:'IN',DistrictID:'FLY-DST-000001',DistrictName:'Kozhikode',State:'Kerala',Status:'Active'},{CountryCode:'IN',DistrictID:'FLY-DST-000002',DistrictName:'Malappuram',State:'Kerala',Status:'Coming Soon'},{CountryCode:'AE',DistrictID:'FLY-DST-UAE-000001',DistrictName:'Dubai',State:'Dubai',Status:'Coming Soon'},{CountryCode:'AE',DistrictID:'FLY-DST-UAE-000002',DistrictName:'Sharjah',State:'Sharjah',Status:'Coming Soon'}],
    categories:[
  ...
  async function loadPublicData(){
    try{
      ...
      ['categories','products','districts','hubs','areas','slots','districtPricing','banners','countries','countryPayments'].forEach(k => state[k] = p[k] || demo[k] || []); currency = currentCurrencySymbol();
